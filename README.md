...
|zipup (1.2.1)		| Zip up files with the given extension with the desired compression tool|
|extractall (1.0)	| Extract all files of the given compression tool type			 |
|convert7z (1.0)	| Converts .7z archives to .zip archives
